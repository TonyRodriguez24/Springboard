...
class StoryList {
  ...
  async addStory(user, { title, author, url }) {
    ...
    //     url: newStory.url,
    //   }
    // }) was confused on where token would go here
    ...
    //ask on how I would be able to look at the response data to find the story
    const story = new Story(response.data.story);
    //add the story to the list of stories using unshift to add it to the beginning of the array
    this.stories.unshift(story);
    //then we add the story to the user's own stories
  ...
  async removeStory(user, storyID) {
    ...
    //filter out the story whose ID we are removing by keeping everything but that story
...
//deletes the story form the APi and remove it from the story lists
